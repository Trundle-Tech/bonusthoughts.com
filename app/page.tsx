    ...
    <div className="relative min-h-screen overflow-hidden bg-[#191919] text-[#F4EDE4]">
      ...
      <section className="relative z-10 mx-auto max-w-7xl px-6 py-24">
        ...
        >
          ...
          <p className="mx-auto max-w-3xl text-lg leading-relaxed text-[#D4C4B0]">
            Enterprise consulting firms excel at theory. We excel at execution. Here's the difference.
          </p>
        </motion.div>
        ...
        <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
          ...
          <motion.div
            ...
            className="rounded-xl border border-[#F4EDE4]/10 bg-gradient-to-br from-[#191919]/50 to-[#2a2a2a]/50 p-8 backdrop-blur-sm"
          >
            <h3 className="mb-6 text-2xl font-bold text-[#D4C4B0]">Big Three Consulting</h3>
            <p className="text-sm text-[#A8826B] mb-4 font-semibold">McKinsey, BCG, Bain</p>
            <ul className="space-y-3 text-sm text-[#D4C4B0]">
              <li className="flex gap-2">
                <span className="text-[#E8956D]">•</span>
                <span>6–18 month engagements</span>
              </li>
              <li className="flex gap-2">
                <span className="text-[#E8956D]">•</span>
                <span>$500K–$5M+ per engagement</span>
              </li>
              <li className="flex gap-2">
                <span className="text-[#E8956D]">•</span>
                <span>Theory-first roadmaps</span>
              </li>
              <li className="flex gap-2">
                <span className="text-[#E8956D]">•</span>
                <span>Hand-offs to implementation partners</span>
              </li>
              <li className="flex gap-2">
                <span className="text-[#E8956D]">•</span>
                <span>Outcomes-based pricing (recent shift)</span>
              </li>
            </ul>
          </motion.div>
          ...
          <motion.div
            ...
            className="rounded-xl border border-[#CC785C]/50 bg-gradient-to-br from-[#CC785C]/10 to-[#E8956D]/10 p-8 backdrop-blur-sm ring-1 ring-[#CC785C]/20"
          >
            <h3 className="mb-6 text-2xl font-bold text-[#F4EDE4]">BonusThoughts</h3>
            <p className="text-sm text-[#CC785C] mb-4 font-semibold">AI Program Direction</p>
            <ul className="space-y-3 text-sm text-[#D4C4B0]">
              <li className="flex gap-2">
                <span className="text-[#00E5FF]">✓</span>
                <span>10–16 week execution</span>
              </li>
              <li className="flex gap-2">
                <span className="text-[#00E5FF]">✓</span>
                <span>$25K–$500K (transparent pricing)</span>
              </li>
              <li className="flex gap-2">
                <span className="text-[#00E5FF]">✓</span>
                <span>Production-ready AI in weeks</span>
              </li>
              <li className="flex gap-2">
                <span className="text-[#00E5FF]">✓</span>
                <span>Your team + my oversight</span>
              </li>
              <li className="flex gap-2">
                <span className="text-[#00E5FF]">✓</span>
                <span>Fixed outcomes, not hours</span>
              </li>
            </ul>
          </motion.div>
          ...
          <motion.div
            ...
            className="rounded-xl border border-[#F4EDE4]/10 bg-gradient-to-br from-[#191919]/50 to-[#2a2a2a]/50 p-8 backdrop-blur-sm"
          >
            <h3 className="mb-6 text-2xl font-bold text-[#D4C4B0]">Dev Shops / Agencies</h3>
            <p className="text-sm text-[#A8826B] mb-4 font-semibold">Freelancers, boutiques</p>
            <ul className="space-y-3 text-sm text-[#D4C4B0]">
              <li className="flex gap-2">
                <span className="text-[#E8956D]">•</span>
                <span>Build, but no strategy</span>
              </li>
              <li className="flex gap-2">
                <span className="text-[#E8956D]">•</span>
                <span>Low cost, high risk</span>
              </li>
              <li className="flex gap-2">
                <span className="text-[#E8956D]">•</span>
                <span>No operational knowledge</span>
              </li>
              <li className="flex gap-2">
                <span className="text-[#E8956D]">•</span>
                <span>Hourly billing (scope creep)</span>
              </li>
              <li className="flex gap-2">
                <span className="text-[#E8956D]">•</span>
                <span>Your problem when they leave</span>
              </li>
            </ul>
          </motion.div>
        </div>
        ...
        <motion.div
          ...
          className="mt-16 rounded-2xl border border-[#CC785C]/30 bg-gradient-to-br from-[#CC785C]/10 to-[#E8956D]/10 p-8 text-center backdrop-blur-sm"
        >
          <p className="text-lg text-[#D4C4B0] mb-4">
            <span className="font-semibold text-[#F4EDE4]">The unlock:</span> Strategy + Speed + Accountability. Built by someone who's shipped classified AI in the field, not from a PowerPoint.
          </p>
        </motion.div>
      </section>
